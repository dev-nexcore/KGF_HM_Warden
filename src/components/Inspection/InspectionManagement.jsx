...
//         // Extract unique room numbers for dropdown
...
//           </div>
//           {/* <div>
//             <label className="block text-sm font-semibold text-gray-800 mb-1">Time (HH or HH:MM)</label>
//             <input
//               type="text"
//               placeholder="e.g., 09 or 09:00"
//               value={filters.time}
...
//               className="bg-blue-500 text-white rounded px-4 py-2 text-sm hover:bg-blue-600 w-full"
//             >
//               Apply Filters
//             </button>
//           </div>
...
//                     {item.status === 'Pending' && (
//                       <button onClick={() => markComplete(item._id)}>✅</button>
//                     )}
//                   </td>
//                 </tr>
//               ))}
...
//             <p className={`font-semibold ${item.status === 'Completed' ? 'text-green-600' : 'text-orange-500'}`}>
//               <strong>Status:</strong> {item.status}
//             </p>
//             {item.status === 'Pending' && (
//               <button onClick={() => markComplete(item._id)} className="mt-2 bg-blue-500 text-white px-3 py-1 rounded">
//                 Mark Complete
//               </button>
//             )}
//           </div>
...
//         setInspections(res.data.inspections);
//         const uniqueTargets = [
//           ...new Set(res.data.inspections.map((item) => item.target)),
//         ];
//         setRoomOptions(uniqueTargets);
//       }
//     } catch (err) {
...
//               className="bg-gray-200 text-black rounded px-4 py-2 text-sm w-full hover:bg-gray-300"
//             >
//               Clear Filters
//             </button>
//           </div>
