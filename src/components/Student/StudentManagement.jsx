      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex gap-2">
          <button
            ...
            className={`px-6 py-2.5 rounded-lg font-semibold transition-all duration-200 ${activeTab === "students"
          ...
          <button
            ...
            className={`px-6 py-2.5 rounded-lg font-semibold transition-all duration-200 ${activeTab === "parents"
                ? "bg-[#A4B494] text-white shadow-md"
                : "bg-gray-100 text-gray-600 hover:bg-gray-200"
              }`}
          >
          ...
          <button
            ...
            className={`px-6 py-2.5 rounded-lg font-semibold transition-all duration-200 ${activeTab === "workers"
                ? "bg-[#A4B494] text-white shadow-md"
                : "bg-gray-100 text-gray-600 hover:bg-gray-200"
              }`}
          >
                ...
                {filteredStudents.length === 0 ? (
                  ...
                  filteredStudents.map((s, i) => (
                    <tr key={i} className="hover:bg-[#A4B494]/10 transition-colors duration-150 group">
                      ...
                      <td className="px-4 py-3.5">
                        <span className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold ${s.feeStatus === 'Paid' ? 'bg-green-500 text-white' :
                ...
                <div key={i} className="p-4 hover:bg-gray-50 transition-colors">
                  ...
                  <div className="grid grid-cols-2 gap-2 mb-3">
                    ...
                    <div className="bg-gray-50 rounded-lg px-3 py-2">
                      ...
                      <span className={`inline-flex items-center px-2 py-0.5 rounded-full text-xs font-semibold mt-0.5 ${s.feeStatus === 'Paid' ? 'bg-green-500 text-white' :
                          s.feeStatus === 'Unpaid' ? 'bg-orange-500 text-white' :
                            s.feeStatus === 'Partial' ? 'bg-yellow-500 text-white' :
                              'bg-gray-200 text-gray-600'
                        }`}>
            ...
            <div className="p-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-1">
                  ...
                  <span className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-semibold ${selectedStudent.feeStatus === 'Paid' ? 'bg-green-500 text-white' :
