...
//       try {
//         const res = await axios.get("http://localhost:5000/api/wardenauth/warden-dashboard"); // Update the API route if needed
//         setStats(res.data);
//       } catch (error) {
...
//             <img src="/dashboard-icons/t-students.png" alt="Users Icon" className="absolute top-0 right-0 w-7 h-7 object-contain" />
...
//           {/* Occupied Beds */}
//           <div className="bg-[#bfc8ad] rounded-2xl p-4 relative shadow w-60 h-24 flex flex-col">
//             <img src="dashboard-icons/beds.png" alt="Checkmark Icon" className="absolute top-0 right-0 w-7 h-7 object-contain" />
...
//           {/* Vacant Beds */}
//           <div className="bg-[#bfc8ad] rounded-2xl p-4 relative shadow w-60 h-24 flex flex-col">
//             <img src="dashboard-icons/beds.png" alt="Layers Icon" className="absolute top-0 right-0 w-7 h-7 object-contain" />
...
//           {/* Damaged Beds */}
//           <div className="bg-[#bfc8ad] rounded-2xl p-4 relative shadow w-60 h-24 flex flex-col">
//             <img src="dashboard-icons/beds.png" alt="Cross Icon" className="absolute top-0 right-0 w-7 h-7 object-contain" />
...
//               <li key={idx} className="flex justify-between items-center py-3 text-sm md:text-base">
